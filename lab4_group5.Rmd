...
```{r  fig.width = 15, fig.height=7, out.width='75%', out.height='75%', fig.cap="ROC Curves for Models", fig.cap="Hyperparameter tuning for KNN",fig.show='hold',fig.align='center',}
...
```{r  fig.width = 15, fig.height=7, out.width='75%', out.height='75%', fig.cap="ROC Curves for Models", fig.cap="Hyperparameter tuning for Random Forest",fig.show='hold',fig.align='center',}
...
```{r  fig.width = 15, fig.height=7,  out.width='75%', out.height='75%', fig.cap="ROC Curves for Models", fig.cap="Hyperparameter tuning for Logistic Regression",fig.show='hold',fig.align='center',}
...
```{r  fig.width = 15, fig.height=7, out.width='75%', out.height='75%', fig.cap="ROC Curves for Models", fig.cap="Convergence of the Random Forest model",fig.show='hold',fig.align='center'}
...
```{r  fig.width = 15, fig.height=7, out.width='75%', out.height='75%', fig.cap="ROC Curves for Models", fig.cap=" Ploting the Feature Importance of the Random Forest model",fig.show='hold',fig.align='center'}
...
p <- ggarrange(ndai_miss_dist, ndai_corr_dist, sd_miss_dist, sd_corr_dist,
