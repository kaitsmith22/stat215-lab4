...
```{r image1, fig.width = 20, fig.height=20, out.width='100%', out.height='100%', fig.cap="Plotting features for image1 on maps" }
...
``` 
```{r, image2, fid.width = 10, fig.height=10, dpi=72, fig.asp= 0.6, fig.cap="Plotting features for image2 on maps" }
maps2 <- lapply(3:11, heatmap_ggplot, img2)

ggarrange(plotlist = maps2)
```
```{r, fid.width = 30, fig.height=10, fig.cap="Plotting features for image3 on maps" }
...
```{r, fig.width = 20, fig.cap="Plotting two-way correlation matrices of the features for image1." }
M <- cor(img1)

corrplot(M, method="number")
```
```{r, fig.width = 8, fig.asp = 0.5, fig.cap="Plotting two-way correlation matrices of the features for image2." }
M2 <- cor(img2)

corrplot(M2, method="number")
```
```{r, fig.width = 8, fig.asp = 0.5, fig.cap="Plotting two-way correlation matrices of the features for image3." }
M3 <- cor(img3)
